...
public class SwaggerConfig {
	...
	ApiInfo apiInfo = new ApiInfo("Security + Jwt Web Service documentation",
			"This pages documents Security + Jwt Web Service endpoints", "1.0",
			"", contact, "Apache 2.0",
	...
	public Docket apiDocket() {
		...
		Docket docket = new Docket(DocumentationType.SWAGGER_2).protocols(new HashSet<>(Arrays.asList("HTTP", "HTTPs")))
				.apiInfo(apiInfo).select().apis(RequestHandlerSelectors.basePackage("com.appsdeveloperblog.app.ws"))
